...
const getBaseBranch = async (octokitClient, owner, repoName) => {
...
const getLatestCommitSHA = async (octokitClient, owner, repoName, baseBranch) => {
  try {
...
const creatingNewBranch = async (octokitClient, owner, repoName, newBranchName, commitSha) => {
  try {
...
const createDocument = async (octokitClient, owner, repoName) => {
  try {
...
const createTree = async (octokitClient, owner, repoName, newTreeSha, blobData) => {
  try {
...
const createCommit = async (req, res) => {
  ...
  if (event === "issues" && action === "opened") {
    ...
    try {
      ...
      const blobData = await createDocument(octokitClient, owner, repoName);
